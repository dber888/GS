...
(function($){
	...
	// $.fn.test = function(this_conf){
	// 	console.log('TEST');
	// 	conf.colors = this_conf.colors;
	...
	function GradientLetters(jContainer, conf) {
		...
		// 	var fc = conf.colors[0];

		// 	for (var i = 0; i < conf.colors.length - 1; i++){
		// 		conf.colors[i] = conf.colors[i+1];
		// 	}

		// 	conf.colors[conf.colors.length - 1] = fc;
