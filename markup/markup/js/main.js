...
$(document).ready(function(){
  ...
  //Mobile menu END
	...
	Snap.load("img/projecting_icon.svg", function (f) {
	...
	Snap.load("img/development_icon.svg", function (f) {
	...
	Snap.load("img/design_icon.svg", function (f) {
	line = f.select(".line");
	...
	Des_anim(0);
	setInterval(function(){Des_anim(0)}, 6500);
	...
	Snap.load("img/support_icon.svg", function (f) {
...
// debugger;
	if (window.matchMedia('(max-width: 767px)').matches) {
		...
		if ($("div.index_block .work_items").hasClass('col_lists')) {
			$("div.index_block .work_items").removeClass('col_lists').find("div.work_item").unwrap();
		}
